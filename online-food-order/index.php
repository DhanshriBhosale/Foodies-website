        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Then Easiest way to order your favourite food among these dishes</p>
                </div>
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a cafe</h3>
                                    <p>We"ve got your covered with menus from a variety of delivery cafes online.</p>
                                </div>
                            </div>
                        </div>
